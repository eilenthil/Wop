...
// configuration step. It creates a namespace called `Wop`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Wop::cmake::project_name, Wop::cmake::project_version) };
